...
export const workoutPlan: WorkoutPlan = {
  "Day 1": {
    ...
    finisher: ["Bench Dips to Failure - 3 sets", "Dumbbell Pull-Over - 12-15 reps"]
  },
  "Day 2": {
  ...
  "Day 3": {
    ...
    abs: [
      {
        superset: ["Dumbbell Russian Twists - 12 reps per side", "Weighted Leg Raises - 15 reps"]
      }
    ],
  ...
  "Day 5": {
    ...
    finisher: ["5-minute AMRAP: 10 Dumbbell Swings, 10 Dumbbell Step-Ups, 10 Dumbbell Bicep Curls"]
  }
};